...
if __name__ == "__main__":
    ...
    agent = DDQNAgent(env=env, name="ddqn", chkpt_path=checkpoint_path, **agent_params)
    ...
    output_path = os.path.join(checkpoint_path, "samples.csv")
    ...
    analysis_path = os.path.join(checkpoint_path, "analysis.txt")
